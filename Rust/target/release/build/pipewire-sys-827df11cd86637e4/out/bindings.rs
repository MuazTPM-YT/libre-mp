...
pub const PW_KEY_NODE_PHYSICAL: &[u8; 14] = b"node.physical\0";
pub const PW_KEY_NODE_TERMINAL: &[u8; 14] = b"node.terminal\0";
pub const PW_KEY_NODE_RELIABLE: &[u8; 14] = b"node.reliable\0";
...
pub const PW_KEY_PORT_EXCLUSIVE: &[u8; 15] = b"port.exclusive\0";
pub const PW_KEY_PORT_RELIABLE: &[u8; 14] = b"port.reliable\0";
...
pub const PW_VERSION_IMPL_PORT_EVENTS: u32 = 4;
...
#[doc = " \\addtogroup pw_timer_queue\n \\{"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct pw_timer_queue {
    _unused: [u8; 0],
}
unsafe extern "C" {
    #[doc = " Get the timer queue from the context: Since 1.6.0"]
    pub fn pw_context_get_timer_queue(context: *mut pw_context) -> *mut pw_timer_queue;
}
unsafe extern "C" {
...
unsafe extern "C" {
    #[doc = " Query the time on the stream. Returns an error when the stream is not running. RT safe"]
...
unsafe extern "C" {
    #[doc = " Check if inside the thread. This can be called from any thread."]
...
pub type pw_timer_callback =
    ::std::option::Option<unsafe extern "C" fn(data: *mut ::std::os::raw::c_void)>;
#[repr(C)]
pub struct pw_timer {
    pub link: spa_list,
    pub queue: *mut pw_timer_queue,
    pub timeout: timespec,
    pub callback: pw_timer_callback,
    pub data: *mut ::std::os::raw::c_void,
    pub padding: [u32; 16usize],
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of pw_timer"][::std::mem::size_of::<pw_timer>() - 120usize];
    ["Alignment of pw_timer"][::std::mem::align_of::<pw_timer>() - 8usize];
    ["Offset of field: pw_timer::link"][::std::mem::offset_of!(pw_timer, link) - 0usize];
    ["Offset of field: pw_timer::queue"][::std::mem::offset_of!(pw_timer, queue) - 16usize];
    ["Offset of field: pw_timer::timeout"][::std::mem::offset_of!(pw_timer, timeout) - 24usize];
    ["Offset of field: pw_timer::callback"][::std::mem::offset_of!(pw_timer, callback) - 40usize];
    ["Offset of field: pw_timer::data"][::std::mem::offset_of!(pw_timer, data) - 48usize];
    ["Offset of field: pw_timer::padding"][::std::mem::offset_of!(pw_timer, padding) - 56usize];
};
unsafe extern "C" {
    pub fn pw_timer_queue_new(loop_: *mut pw_loop) -> *mut pw_timer_queue;
}
unsafe extern "C" {
    pub fn pw_timer_queue_destroy(queue: *mut pw_timer_queue);
}
unsafe extern "C" {
    pub fn pw_timer_queue_add(
        queue: *mut pw_timer_queue,
        timer: *mut pw_timer,
        abs_time: *mut timespec,
        timeout_ns: i64,
...
unsafe extern "C" {
    pub fn pw_timer_queue_cancel(timer: *mut pw_timer) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
...
unsafe extern "C" {
    #[doc = " Get a free unused port from the node"]
    pub fn pw_impl_node_get_free_port(
        node: *mut pw_impl_node,
        direction: spa_direction,
    ) -> *mut pw_impl_port;
}
...
pub struct pw_impl_port_events {
    ...
    #[doc = " capability changed. Since version 4"]
    pub capability_changed:
        ::std::option::Option<unsafe extern "C" fn(data: *mut ::std::os::raw::c_void)>,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of pw_impl_port_events"][::std::mem::size_of::<pw_impl_port_events>() - 112usize];
    ...
    ["Offset of field: pw_impl_port_events::capability_changed"]
        [::std::mem::offset_of!(pw_impl_port_events, capability_changed) - 104usize];
};
unsafe extern "C" {
